...
class PlantRecogniserRice extends StatefulWidget {
  ...
  @override
  State<PlantRecogniserRice> createState() => _PlantRecogniserState();
}
...
class _PlantRecogniserState extends State<PlantRecogniserRice> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (label) => {Navigator.pop<PlantRecogniserRice>(context)},
      ),
